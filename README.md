# valuations-aicountly

Valuations for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://valuations.aicountly.com | https://valuations.aicountly.com/api |
| Sandbox | https://valuations.gh.aicountly.com | https://valuations.gh.aicountly.com/api |
...
(`https://valuations.gh.aicountly.com/api`) so the token exchange has somewhere to
