 ...
 * valuations.aicountly.com and valuations.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'valuations').trim() || 'valuations'
...
/**
 * `valuations.aicountly.com` and `valuations.gh.aicountly.com` both resolve to
 * `valuations`, which is what the portal expects in authentication_jump.
 */
