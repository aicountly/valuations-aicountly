...
export const APP_NAME = (import.meta.env.VITE_APP_NAME ?? 'Valuations').trim() || 'Valuations'
 ...
 * with the app on both valuations.aicountly.com and valuations.gh.aicountly.com. That
