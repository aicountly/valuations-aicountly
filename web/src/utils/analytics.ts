/**
 * Google Analytics 4 (gtag) for valuations.aicountly.com.
 *
 * Set at build time: VITE_GA4_SAAS_VALUATIONS_MEASUREMENT_ID=G-…
 * Flow backend: GA4_PROPERTY_ID_SAAS_VALUATIONS (numeric property ID).
 */
...
const GA4_ID: string =
  import.meta.env.VITE_GA4_SAAS_VALUATIONS_MEASUREMENT_ID ||
